...
describe('WebsiteUser Management Component', () => {
  let comp: WebsiteUserComponent;
  let fixture: ComponentFixture<WebsiteUserComponent>;
  let service: WebsiteUserService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'website-user', component: WebsiteUserComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(WebsiteUserComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.websiteUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
